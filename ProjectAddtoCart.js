...
allbtn.addEventListener("click", () => {
  if (subnavv.style.display == "") {
    ...
    allimg.src =
      "https://icon-library.com/images/cancel-icon-transparent/cancel-icon-transparent-3.jpg";
...
btn.forEach((btn) => {
  btn.addEventListener("click", () => {
    ...
    cartdiv.forEach((cartdiv) => {
      var pricebeforeinc =
        cartdiv.getElementsByClassName("addprice")[0].innerHTML;
      ...
      clearx.forEach((clearx) => {
        clearx.addEventListener("click", () => {
          totalprice -= Number(
            cartdiv.getElementsByClassName("addpriceqty")[0].innerHTML
          );
          total.innerHTML = totalprice;
          --Count;
          itemcount.innerHTML = Count;
    ...
    success.addEventListener("click", () => {
      if (Count == 0) {
        ...
        alert(
          "your order has been placed successfully Thank you for using Fresh Mart"
        );
      }
    });
    // save();
...
wishlist.forEach((wishlist) => {
  wishlist.addEventListener("click", () => {
    if (
      wishlist.src ==
      "https://png.pngitem.com/pimgs/s/529-5299573_heart-white-png-transparent-png.png"
    ) {
      wishlist.src =
        "https://icon-library.com/images/heart-icon-svg/heart-icon-svg-14.jpg";
    } else {
      wishlist.src =
        "https://png.pngitem.com/pimgs/s/529-5299573_heart-white-png-transparent-png.png";
    }
...
// function save() {
//   localStorage.setItem("store", displayitems.innerHTML);
// }

// function show() {
//   displayitems.innerHTML = localStorage.getItem("store");
// }
// show();
